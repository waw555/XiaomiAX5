            ...
            P = {
                render: function() {
                    ...
                    return s("div", [s("div", {
                        ...
                        slot: "checklength"
                    }, [e._v("*Имя Wi-Fi может содержать не более 28 символов.")]), e._v(" "), s("div", {
                        attrs: {
                        ...
                        slot: "wifipassword"
                    }, [e._v("*Пожалуйста, введите цифры, латинские буквы или символы.")]), e._v(" "), s("div", {
                        attrs: {
                            slot: "filterspecialchar"
                        },
                        slot: "filterspecialchar"
                        ...
                        slot: "maxlength"
                    }, [e._v("*Пароль Администратора, должен содержать не более 63 символов.")])]), e._v(" "), s("ul", {
                    ...
                    }), e._v("Автоматически обновлять програмное обеспечение, когда маршрутизатор находится в режиме ожидания.")], 1)])], 1), e._v(" "), s("div", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: e.showBtn,
                    ...
                    }, [e._v("В настоящее время маршрутизатор работает в режиме DHCP, вы также можете выбрать другие режимы."), s("a", {
                        attrs: {
                            href: ""
                        },
                        on: {
                ...
                staticRenderFns: [function() {
                    ...
                    return t("div", {
                        staticClass: "main"
                    }, [t("h4", [this._v("Автоматическое определение настроек IP или DHCP адресов")]), this._v(" "), t("h4", [this._v("Пожалуйста, нажмите Далее")])])
                }]
            };
        ...
        var r = s("PkfQ"),
            ...
            o = {
                render: function() {
                    ...
                    return s("div", {
                    ...
                    }), e._v(" "), s("p", [e._v("Настройка завершена, производится перезапуск сети Wi-Fi.")]), e._v(" "), s("p", [e._v("Подключитесь к Wi-Fi еще раз, чтобы получить доступ к Интернету.")]), e._v(" "), e.wireless ? s("p", {
                        staticClass: "fail"
                    }, [e._v("Если Wi-Fi сеть не определяется, измените конфигурацию в настройках маршрутизатора.")]) : e._e()]), e._v(" "), s("div", {
                        ref: "con",
                        ...
                        attrs: {
                            name: "Сохраните или запишите Ваш пароль Wi-Fi."
                        }
                    }), e._v(" "), s("div", {
