webpackJsonp([2, 15, 20], {
    ...
    TUNY: function(e, t, s) {
            ...
            u = {
                ...
                methods: {
                    handleBack: function(e) {
                        2 == e && this.currentWifiEncry && e--, this.step = e
                    },
                        ...
                        return o()(r.a.mark(function t() {
                            ...
                            return r.a.wrap(function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        return t.next = 2, e.axios.getWifiList();
                                    case 2:
                                        0 == (s = t.sent).data.code && (e.step = 1, e.list = s.data.list);
                                    case 4:
                                    case "end":
                                        return t.stop()
                                }
                    ...
                    goDetail: function(e) {
                        this.wifi.ssid = e.ssid, this.wifi.channel = e.channel, this.wifi.band = e.band, this.wifi.encryption = e.encryption, this.wifi.enctype = e.enctype, this.encryption = e.encryption, "NONE" == e.encryption ? (this.currentWifiEncry = !0, this.step = 3, this.wifi.nssid = this.wifi.ssid + "_plus") : (this.currentWifiEncry = !1, this.step = 2)
                    },
                    switchPwdType: function(e) {
                        0 == e ? this.passtype = "password" === this.passtype ? "text" : "password" : 1 == e ? this.Router_passtype = "password" === this.Router_passtype ? "text" : "password" : 2 == e && (this.passtype_ap = "password" === this.passtype_ap ? "text" : "password")
                    },
                    onSubmit: function() {
                        var e = this;
                        return o()(r.a.mark(function t() {
                            ...
                            return r.a.wrap(function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        ...
                                        if (!e.formstate.name1.$invalid && !e.formstate.password1.$invalid) {
                                            t.next = 3;
                                            break
                                        }
                                        return t.abrupt("return");
                                    case 3:
                                        e.step = 5, setTimeout(function() {
                                            e.step = 3, e.wifi.nssid = e.wifi.ssid + "_plus"
                                        }, 1e3), t.next = 39;
                                        break;
                                    case 7:
                                        if (3 !== e.step) {
                                        ...
                                        if (e.routerPwd = e.wifi.npassword, !e.formstate.name2.$invalid && !e.formstate.password2.$invalid) {
                                            t.next = 12;
                                            break
                                        }
                                        return t.abrupt("return");
                                    case 12:
                                        ...
                                        break;
                                    case 14:
                                        if (!(e.formstate.name2.$invalid || e.formstate.password2.$invalid || e.formstate.routerPwd.$invalid)) {
                                            t.next = 16;
                                            break
                                        }
                                        return t.abrupt("return");
                                    case 16:
                                        return e.step = 5, e.wifi.name = e.wifi.nssid, e.wifi.nssid5G = e.wifi.nssid + "_5G", e.wifi.nonce = e.common.Encrypt.init(), e.wifi.oldPwd = e.common.Encrypt.oldPwd("admin"), e.wifi.newPwd = e.common.Encrypt.newPwd("admin", e.routerPwd), s = {
                                            info: "auto_upgrade=" + (e.update ? 1 : 0)
                                        }, t.next = 25, e.axios.upgrade(s);
                                    case 25:
                                        return t.sent, t.next = 28, e.common.setInitLog({
                                            type: 0,
                                            step: "wireless_relay_done"
                                        });
                                    case 28:
                                        return e.step = 6, e.GLOBAL.adminPassword = e.routerPwd, e.adminPassword = e.routerPwd, e.result = {
                                            ssid2g_ssid: e.wifi.nssid,
                                            ssid2g_passwd: e.wifi.npassword
                                        }, (i = e.common.getCookie("hardware")) && "R3L" != i && "R4C" != i && "R1CL" != i && "R4CM" != i && (e.result.ssid5g_ssid = e.wifi.nssid + "_5G", e.result.ssid5g_passwd = e.wifi.npassword), e.wifi.password || (e.wifi.encryption = "NONE", e.wifi.enctype = "NONE"), t.next = 37, e.axios.postWireless(e.wifi);
                                    case 37:
                                        t.sent.data.code;
                                    case 39:
                                    case "end":
            ...
            v = {
                render: function() {
                    var e = this,
                        ...
                        s = e._self._c || t;
                    return s("div", {
                        staticClass: "wireless"
                    }, [s("div", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: 1 === e.step || 2 === e.step || 3 === e.step,
                        ...
                        staticClass: "wifilist width100"
                    }, [s("ul", e._l(e.list, function(t, i) {
                        return s("li", {
                            key: i,
                            on: {
                                click: function(s) {
                        ...
                        }, [e._v(e._s(t.ssid)), s("span", {
                            staticClass: "iconfont icon-fanhui"
                        })])
                    }), 0)])], 1) : e._e(), e._v(" "), 2 === e.step || 3 === e.step ? s("div", {
                        staticClass: "step3 container"
                    }, [s("Header", {
                        attrs: {
                            name: "Режим Усилителя",
                            step: e.step
                        },
                        on: {
                            goBack: e.handleBack
                        ...
                        on: {
                            input: function(t) {
                                t.target.composing || e.$set(e.wifi, "ssid", t.target.value.trim())
                            },
                            blur: function(t) {
                    ...
                    }, [e._v("Пароль Wi-Fi:")]), e._v(" "), "NONE" != e.encryption ? s("input", {
                        directives: [{
                            name: "model",
                            rawName: "v-model.trim",
                        ...
                        attrs: {
                            placeholder: "Пароль Wi-Fi должен содержать не менее 8 символов",
                            name: "password1",
                            type: e.passtype_ap,
                            wifipassword: "",
                            minlength: "8",
                    ...
                    }) : e._e(), e._v(" "), "NONE" == e.encryption ? s("input", {
                        directives: [{
                            name: "model",
                            rawName: "v-model.trim",
                            value: e.wifi.password,
                        ...
                        class: {
                            blue: "text" === e.passtype_ap
                        },
                        on: {
                            click: function(t) {
                                return e.switchPwdType(2)
                            }
                        }
                        ...
                        slot: "required"
                    }, [e._v("* Имя Wi-Fi не может быть пустым")]), e._v(" "), s("div", {
                        attrs: {
                        ...
                        slot: "minlength"
                    }, [e._v("* Пароль Wi-Fi должен содержать не менее 8 символов")]), e._v(" "), s("div", {
                        attrs: {
                            slot: "maxlength"
                        },
                        slot: "maxlength"
                    }, [e._v("* Пароль Wi-Fi должен содержать не более 63 символов")]), e._v(" "), s("div", {
                        attrs: {
                            slot: "wifipassword"
                        },
                        slot: "wifipassword"
                    }, [e._v("* Используйте цифры, латинские буквы и символы")]), e._v(" "), s("div", {
                        attrs: {
                            slot: "filterspecialchar"
                        },
                        slot: "filterspecialchar"
                    }, [e._v("* Пароль Wi-Fi не может содержать специальные символы такие как:` ; | $ & { } \\")])]), e._v(" "), 2 === e.step ? s("div", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: e.showBtn,
                        ...
                        on: {
                            input: function(t) {
                                t.target.composing || e.$set(e.wifi, "nssid", t.target.value.trim())
                            },
                            blur: function(t) {
                                return e.$forceUpdate()
                            }
                        ...
                        directives: [{
                            name: "model",
                            rawName: "v-model.trim",
                            value: e.wifi.npassword,
                            expression: "wifi.npassword",
                            modifiers: {
                                trim: !0
                            }
                        }],
                        ...
                        on: {
                            input: function(t) {
                                t.target.composing || e.$set(e.wifi, "npassword", t.target.value.trim())
                            },
                            blur: function(t) {
                                return e.$forceUpdate()
                            }
                        ...
                        slot: "checklength"
                    }, [e._v("* Имя Wi-Fi должно быть не более 28 символов")]), e._v(" "), s("div", {
                        attrs: {
                            slot: "filterspecialchar"
                        },
                        slot: "filterspecialchar"
                        ...
                        attrs: {
                            name: "routerPwd",
                            placeholder: "Установите пароль Администратора не менее 8 символов",
                        ...
                        slot: "required"
                    }, [e._v("* Пароль Администратора не может быть пустым")]), e._v(" "), s("div", {
                        attrs: {
                            slot: "minlength"
                        },
                        slot: "minlength"
                    }, [e._v("* Пароль Администратора должен быть не менее 8 символов")]), e._v(" "), s("div", {
                        attrs: {
                            slot: "maxlength"
                        },
                        slot: "maxlength"
                    }, [e._v("* Пароль Администратора должен быть не более 63 символов")]), e._v(" "), s("div", {
                        attrs: {
                            slot: "wifipassword"
                        },
                        slot: "wifipassword"
                    ...
                    }), e._v("Использовать пароль Wi-Fi в качестве пароля Администратора")], 1), e._v(" "), s("li", [s("CheckBox", {
                        attrs: {
                            name: "update",
                            value: "2"
                        },
                    ...
                    }), e._v("Автоматически обновлять версию прошивки, когда маршрутизатор находится в режиме ожидания.")], 1)])]), e._v(" "), 3 === e.step ? s("div", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: e.showBtn,
                    ...
                    }, [e._v("Далее")])]) : e._e()], 1)])], 1) : e._e()]), e._v(" "), 4 === e.step ? s("div", {
                        staticClass: "step1 loading"
                    }, [s("h3", [e._v("Режим Усилителя")]), e._v(" "), s("Loading", {
                        attrs: {
                            desc: "Подождите..."
                        }
                    })], 1) : e._e(), e._v(" "), 5 === e.step ? s("div", {
                        staticClass: "loading"
                    }, [s("h3", [e._v("Режим Усилителя")]), e._v(" "), s("Loading", {
                        attrs: {
                            desc: "Подождите..."
                        }
                    })], 1) : e._e(), e._v(" "), 6 === e.step ? s("Wificomplete", {
                        attrs: {
                            types: 2,
                            resultData: e.result,
        ...
        var m = s("VU/8")(u, v, !1, function(e) {
            s("vABj")
        }, "data-v-7e0deec6", null);
        t.default = m.exports
    },
    XjfA: function(e, t) {},
    "h+4m": function(e, t) {},
    ...
    kDQt: function(e, t, s) {
        ...
        var i = s("teIl"),
            ...
            a = {
                ...
                data: function() {
                    return {
                        typeList: ['Доступ в интернет через <span style="opacity: .4"> PPPOE</span>', 'Получить IP адрес автоматически<span style="opacity: .4"> DHCP</span>', "Статический IP", "Усилитель Wi-Fi", "Точка доступа"],
                        mapTypeLink: [{
                            path: "/guide",
                            query: {
                                type: 1
                ...
                created: function() {
                    ...
                    if (this.$route.query.from) {
                        this.errortip = !0, "wireless" === this.$route.query.from ? this.error_desc = "Неверный пароль Wi-Fi" : "dhcp" === this.$route.query.from ? this.error_desc = "Ошибка конфигурации DHCP" : "wired" === this.$route.query.from ? this.error_desc = "Ошибка конфигурации Точки доступа" : "static" === this.$route.query.from && (this.error_desc = "Не удалось настроить статический IP адрес");
                        var t = this.$router.history.current.path;
                        this.$router.push({
                            path: t
                        }), setTimeout(function() {
                            e.errortip = !1
            ...
            o = {
                render: function() {
                    ...
                    return s("div", {
                        ...
                        attrs: {
                            name: "Выберите тип конфигурации"
                        }
                    }), e._v(" "), s("div", {
                    ...
                    }), e._v(" "), s("ul", e._l(e.typeList, function(t, i) {
        ...
        var i = s("PkfQ"),
            ...
            a = {
                render: function() {
                    ...
                    return s("div", {
                    ...
                    }), e._v(" "), s("p", [e._v("Настройка завершена")]), e._v(" "), s("p", [e._v("Подключитесь к Wi-Fi еще раз, чтобы получить доступ к Интернету")]), e._v(" "), e.wireless ? s("p", {
                        staticClass: "fail"
                    }, [e._v("Если Wi-Fi не найден, это означает, что соединение с не удалось, измените конфигурацию")]) : e._e()]), e._v(" "), s("div", {
                        ref: "con",
                        ...
                        attrs: {
                            name: "Сохраните и запишите Ваш пароль"
                        }
                    }), e._v(" "), s("div", {
                    ...
                    }, [e._v("Панель управления：  " + e._s(e.resultData.lan_ip))]), e._v(" "), s("p", [e._v("Пароль Администратора：  " + e._s(e.adminPassword))]), e._v(" "), s("p", {
                        directives: [{
                            name: "show",
                            rawName: "v-show",
                            value: e.wireless,
