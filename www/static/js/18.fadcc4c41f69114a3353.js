            ...
            i = {
                render: function() {
                    ...
                    return n("div", {
                        ...
                        staticClass: "bottom"
                    }, [n("h3", [t._v("未检测到入户网线")]), t._v(" "), n("p", [t._v("建议您按以下步骤排查问题")]), t._v(" "), n("ul", [n("li", [t._v("1. 请检查路由器WAN或Internet口已用网线连接到光猫/上级设备的LAN口，或已接入入户网线")]), t._v(" "), n("li", [t._v("2. 请检查网线是否插紧或损坏")]), t._v(" "), n("li", [t._v("3. 请检查光猫/上级设备是否正常工作，可尝试重启光猫/上级设备后再连接Wi-Fi")]), t._v(" "), n("li", [t._v("4. 若仍然无法上网，请联系您的 "), n("a", {
                        on: {
                            click: t.operators
                        }
