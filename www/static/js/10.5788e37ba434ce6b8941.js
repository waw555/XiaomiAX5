            ...
            i = {
                render: function() {
                    ...
                    return f("div", {
                        ...
                        staticClass: "title"
                    }, [t._v("\n              2.请将网线的一头插入旧路由器的WAN或Internet口，另一头插入新路由器的LAN口\n          ")]), t._v(" "), f("div", {
                        staticClass: "desc"
                    }, [t._v("\n              如果您缺少网线，可以先将路由器WAN或Internet口的网线拔下来使用\n          ")]), t._v(" "), f("div", {
                        staticClass: "next next_1 width40",
                        on: {
                            click: t.next_2
                        }
                ...
                staticRenderFns: [function() {
                    ...
                    return s("div", {
                        ...
                        staticClass: "warning"
                    }, [this._v("!")]), this._v("从旧路由器获取宽带账号和密码失败\n          ")])
                }, function() {
                    var t = this.$createElement,
                        s = this._self._c || t;
                    return s("div", {
                        staticClass: "desc"
                    }, [s("p", [this._v("1、确认两个路由器的网线连接正确（按照上图所示）")]), this._v(" "), s("p", [this._v("2、确认连接两个路由器的网线是良好的")]), this._v(" "), s("p", [this._v("3、重启旧路由器后，重新尝试")])])
                }]
            };
