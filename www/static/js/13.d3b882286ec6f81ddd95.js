        ...
        var s = i("Xxa5"),
            ...
            c = {
                render: function() {
                    ...
                    return i("div", {
                    ...
                    }, [t._v("2. Избегать конфликта IP адресов")])]), t._v(" "), i("li", [
						...
						t._v("1、拔掉WAN或Internet口网线，将路由器和光猫/Дом庭网关断电重启，10分钟后重插网线")]), t._v(" "), i("li", [
						t._v("2、若仍然无法上网，Обратитесь к своему 您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                        ...
                        staticClass: "desp"
                    }, [t._v("*您当前IP адрес与大部分Дом庭配置不同，请Принять此配置没问题")]), t._v(" "), i("li", [t._v("Мы предлагаем вам выполнить следующие действия, чтобы устранить проблему.")]), t._v(" "), i("li", [t._v("1、请前往修改网关配置")]), t._v(" "), i("li", [t._v("2、请重启路由器和光猫/上级设备")]), t._v(" "), i("li", [t._v("3、若仍然无法上网，Обратитесь к своему 您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")])])]) : t._e(), t._v(" "), 5 == t.type ? i("ul", [i("li", [t._v("Мы предлагаем вам выполнить следующие действия, чтобы устранить проблему.")]), t._v(" "), i("li", [t._v("Обратитесь к своему 您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                        ...
                        staticClass: "content"
                    }, [t.gotopc ? i("p", [t._v("访问电脑版")]) : t._e(), t._v(" "), t.gotopc ? i("p", [t._v("使用更多高级功能")]) : t._e(), t._v(" "), t.avoidip ? i("p", [t._v("Избегать конфликта IP адресов")]) : t._e(), t._v(" "), t.avoidip ? i("p", [t._v("执行此操作，局域网IP将会变更为" + t._s(t.ip) + "该过程无线网络会重启，将出现短暂掉线。")]) : t._e()]), t._v(" "), t.gotopc ? i("div", {
