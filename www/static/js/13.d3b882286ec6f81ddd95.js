        ...
        var s = i("Xxa5"),
            ...
            c = {
                render: function() {
                    ...
                    return i("div", {
                    ...
                    }, [t._v("Провайдеру")])])]) : t._e(), t._v(" "), 9 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、请Принять网线是否插紧或损坏")]), t._v(" "), i("li", [t._v("2、请检查是否光猫或其他上级设备故障，或尝试重启光猫或其他上级设备")]), t._v(" "), i("li", [t._v("3、请重启路由器，并等待启动完成，蓝灯常亮后再尝试Подключить")]), t._v(" "), i("li", [t._v("4、请Принять您手机的IP地址前三段是否为192.168.31，如果不是请将您的IP设置修改为自动或DHCP。\n            （查看及修改位置：手机设置-无线局域网/WLAN-当前WiFi的详情页-配置IP/IP设置）")]), t._v(" "), t._m(0)]) : t._e(), t._v(" "), 8 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、"), i("a", {
                        on: {
                        ...
                        staticClass: "desp"
                    }, [t._v("*您当前IP地址与大部分Дом庭配置不同，请Принять此配置没问题")]), t._v(" "), i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、请前往修改网关配置")]), t._v(" "), i("li", [t._v("2、请重启路由器和光猫/上级设备")]), t._v(" "), i("li", [t._v("3、若仍然无法上网，Обратитесь к своему 您的"), i("a", {
                        on: {
                            click: t.operators
                        }
