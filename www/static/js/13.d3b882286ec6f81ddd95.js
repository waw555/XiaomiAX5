        ...
        var s = i("Xxa5"),
            ...
            c = {
                render: function() {
                    ...
                    return i("div", {
                    ...
                    }, [t._v("Провайдеру")])])]) : t._e(), t._v(" "), 9 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、请确认网线是否插紧或损坏")]), t._v(" "), i("li", [t._v("2、请检查是否光猫或其他上级设备故障，或尝试重启光猫或其他上级设备")]), t._v(" "), i("li", [t._v("3、请重启路由器，并等待启动完成，蓝灯常亮后再尝试连接")]), t._v(" "), i("li", [t._v("4、请确认您手机的IP地址前三段是否为192.168.31，如果不是请将您的IP设置修改为自动或DHCP。\n            （查看及修改位置：手机设置-无线局域网/WLAN-当前WiFi的详情页-配置IP/IP设置）")]), t._v(" "), t._m(0)]) : t._e(), t._v(" "), 8 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、"), i("a", {
                        on: {
                        ...
                        staticClass: "desp"
                    }, [t._v("*当前DNS服务器地址为"), t.dns ? i("span", [t._v(t._s(t.dns) + "，与大部分Дом庭配置不同，")]) : i("span", [t._v("空，")]), t._v("请确认此配置没问题")]), t._v(" "), i("li", [t._v("1、请前往修改Параметры DNS")]), t._v(" "), i("li", [t._v("2、请重启路由器和光猫/上级设备")]), t._v(" "), i("li", [t._v("3、若仍然无法上网，请联系您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")]), t._v("，确认DNS服务是否正常")])]) : t._e(), t._v(" "), 7 == t.type ? i("ul", [i("li", {
                        staticClass: "desp"
                    }, [t._v("*您当前IP地址与大部分Дом庭配置不同，请确认此配置没问题")]), t._v(" "), i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、请前往修改网关配置")]), t._v(" "), i("li", [t._v("2、请重启路由器和光猫/上级设备")]), t._v(" "), i("li", [t._v("3、若仍然无法上网，请联系您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    ...
                    }, [t._v("Провайдеру")]), t._v("，确认账号密码是否正确，以及是否欠费")])]) : t._e(), t._v(" "), 3 == t.type || 4 == t.type || 5 == t.type ? i("ul", {
