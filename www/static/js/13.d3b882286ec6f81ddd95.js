            ...
            c = {
                render: function() {
                    ...
                    return i("div", {
                        ...
                        staticClass: "desp"
                    }, [t._v("*当前Сервер DNS地址为"), t.dns ? i("span", [t._v(t._s(t.dns) + "，与大部分Дом庭配置不同，")]) : i("span", [t._v("空，")]), t._v("请Принять此配置没问题")]), t._v(" "), i("li", [t._v("1、请前往修改Параметры DNS")]), t._v(" "), i("li", [t._v("2、请重启路由器和光猫/上级设备")]), t._v(" "), i("li", [t._v("3、若仍然无法上网，Обратитесь к своему 您的"), i("a", {
                        on: {
                            click: t.operators
                        }
