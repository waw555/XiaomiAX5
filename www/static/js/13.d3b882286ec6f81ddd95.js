        ...
        var s = i("Xxa5"),
            ...
            c = {
                render: function() {
                    ...
                    }, [t._v("避让IP冲突")])]), t._v(" "), i("li", [t._v("3、若以上2种方案均无法解决该问题，建议您重启光猫/上级设备3分钟后再重启路由器")]), t._v(" "), t._m(1)]) : t._e(), t._v(" "), 0 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1. 请重启路由器，并等待启动完成，蓝灯常亮后再尝试Подключить")]), t._v(" "), t._m(2)]) : t._e(), t._v(" "), 1 == t.type || 6 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、请检查路由器WAN或Internet口是否有网线Подключить，是否插牢")]), t._v(" "), i("li", [t._v("2、请检查网线另一端是否Подключить在光猫/上级设备的LAN口")]), t._v(" "), i("li", [t._v("3、请检查网线是否完好")]), t._v(" "), i("li", [t._v("4、请更换光猫/上级设备的插入网线端口并插牢固")]), t._v(" "), i("li", [t._v("5、请重启光猫/上级设备")]), t._v(" "), i("li", [t._v("6、请重启路由器，并等待启动完成（蓝灯常亮）")]), t._v(" "), i("li", [t._v("7、若仍然无法上网，请联系你的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")])])]) : t._e(), t._v(" "), 3 == t.type || 4 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、拔掉WAN或Internet口网线，将路由器和光猫/Дом庭网关断电重启，10分钟后重插网线")]), t._v(" "), i("li", [t._v("2、若仍然无法上网，请联系您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")])])]) : t._e()]), t._v(" "), 2 == t.type ? i("ul", [i("li", {
                        staticClass: "desp"
                    }, [t._v("*当前DNS服务器地址为"), t.dns ? i("span", [t._v(t._s(t.dns) + "，与大部分Дом庭配置不同，")]) : i("span", [t._v("空，")]), t._v("请Принять此配置没问题")]), t._v(" "), i("li", [t._v("1、请前往修改Параметры DNS")]), t._v(" "), i("li", [t._v("2、请重启路由器和光猫/上级设备")]), t._v(" "), i("li", [t._v("3、若仍然无法上网，请联系您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")]), t._v("，ПринятьDNS服务是否正常")])]) : t._e(), t._v(" "), 7 == t.type ? i("ul", [i("li", {
                        staticClass: "desp"
                    }, [t._v("*您当前IP地址与大部分Дом庭配置不同，请Принять此配置没问题")]), t._v(" "), i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、请前往修改网关配置")]), t._v(" "), i("li", [t._v("2、请重启路由器和光猫/上级设备")]), t._v(" "), i("li", [t._v("3、若仍然无法上网，请联系您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")])])]) : t._e(), t._v(" "), 5 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("请联系您的"), i("a", {
                        on: {
                            click: t.operators
                        }
