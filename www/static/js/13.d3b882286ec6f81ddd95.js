            ...
            c = {
                render: function() {
                    ...
                    return i("div", {
                        ...
                        staticClass: "main"
                    }, [0 == t.type || 9 == t.type ? i("h3", [t._v("网络通信异常")]) : t._e(), t._v(" "), 1 == t.type || 7 == t.type ? i("h3", [t._v("网关不可达")]) : t._e(), t._v(" "), 2 == t.type ? i("h3", [t._v("DNS解析失败")]) : t._e(), t._v(" "), 3 == t.type ? i("h3", [t._v("同一账号重复登录（Код ошибки: 678）")]) : t._e(), t._v(" "), 4 == t.type ? i("h3", [t._v("Имя пользователя异常 "), "none" != t.errorCode ? i("span", [t._v("（错误码" + t._s(t.errorCode) + "）")]) : t._e()]) : t._e(), t._v(" "), 5 == t.type ? i("h3", [t._v("Имя пользователя或密码错误（Код ошибки: 691）")]) : t._e(), t._v(" "), 6 == t.type ? i("h3", [t._v("无DHCP Sever")]) : t._e(), t._v(" "), 8 == t.type ? i("h3", [t._v("检测到与上级路由器存在IP冲突")]) : t._e(), t._v(" "), 10 == t.type ? i("h3", [t._v("WAN或Internet口链路不通")]) : t._e(), t._v(" "), i("div", {
                        staticClass: "desc"
                    }, [10 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、请检查您是否有配置VPN")]), t._v(" "), i("li", [t._v("2、如果您配置了VPN，则可能是您的VPN链路不通，请检查您的VPN设置")]), t._v(" "), i("li", [t._v("3、如果您没有配置VPN，请检查您的网线是否完好，可以尝试插拔网线再次判断状态")]), t._v(" "), i("li", [t._v("4、插拔网线后仍无法上网，请重启您的路由器")]), t._v(" "), i("li", [t._v("5、若仍然无法上网，Обратитесь к своему 你的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")])])]) : t._e(), t._v(" "), 9 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、请Принять网线是否插紧或损坏")]), t._v(" "), i("li", [t._v("2、请检查是否光猫或其他上级设备故障，或尝试重启光猫或其他上级设备")]), t._v(" "), i("li", [t._v("3、请重启路由器，并等待启动完成，蓝灯常亮后再尝试Подключить")]), t._v(" "), i("li", [t._v("4、请Принять您手机的IP адрес前三段是否为192.168.31，如果不是请将您的IP设置修改为自动或DHCP。\n            （查看及修改位置：手机设置-无线局域网/WLAN-当前WiFi的详情页-配置IP/IP设置）")]), t._v(" "), t._m(0)]) : t._e(), t._v(" "), 8 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、"), i("a", {
                        on: {
                            click: t.gotopcsetting
                        }
                    }, [t._v("切换到Режим Точка доступа")])]), t._v(" "), i("li", [t._v("2、"), i("a", {
                        on: {
                            click: t.avoidipconflict
                        }
                    }, [t._v("避让IP冲突")])]), t._v(" "), i("li", [t._v("3、若以上2种方案均无法解决该问题，建议您重启光猫/上级设备3分钟后再重启路由器")]), t._v(" "), t._m(1)]) : t._e(), t._v(" "), 0 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1. 请重启路由器，并等待启动完成，蓝灯常亮后再尝试Подключить")]), t._v(" "), t._m(2)]) : t._e(), t._v(" "), 1 == t.type || 6 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、请检查路由器WAN或Internet口是否有网线Подключить，是否插牢")]), t._v(" "), i("li", [t._v("2、请检查网线另一端是否Подключить在光猫/上级设备的LAN口")]), t._v(" "), i("li", [t._v("3、请检查网线是否完好")]), t._v(" "), i("li", [t._v("4、请更换光猫/上级设备的插入网线端口并插牢固")]), t._v(" "), i("li", [t._v("5、请重启光猫/上级设备")]), t._v(" "), i("li", [t._v("6、请重启路由器，并等待启动完成（蓝灯常亮）")]), t._v(" "), i("li", [t._v("7、若仍然无法上网，Обратитесь к своему 你的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")])])]) : t._e(), t._v(" "), 3 == t.type || 4 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、拔掉WAN或Internet口网线，将路由器和光猫/Дом庭网关断电重启，10分钟后重插网线")]), t._v(" "), i("li", [t._v("2、若仍然无法上网，Обратитесь к своему 您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")])])]) : t._e()]), t._v(" "), 2 == t.type ? i("ul", [i("li", {
                        staticClass: "desp"
                    }, [t._v("*当前DNS服务器地址为"), t.dns ? i("span", [t._v(t._s(t.dns) + "，与大部分Дом庭配置不同，")]) : i("span", [t._v("空，")]), t._v("请Принять此配置没问题")]), t._v(" "), i("li", [t._v("1、请前往修改Параметры DNS")]), t._v(" "), i("li", [t._v("2、请重启路由器和光猫/上级设备")]), t._v(" "), i("li", [t._v("3、若仍然无法上网，Обратитесь к своему 您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")]), t._v("，ПринятьDNS服务是否正常")])]) : t._e(), t._v(" "), 7 == t.type ? i("ul", [i("li", {
                        staticClass: "desp"
                    }, [t._v("*您当前IP адрес与大部分Дом庭配置不同，请Принять此配置没问题")]), t._v(" "), i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("1、请前往修改网关配置")]), t._v(" "), i("li", [t._v("2、请重启路由器和光猫/上级设备")]), t._v(" "), i("li", [t._v("3、若仍然无法上网，Обратитесь к своему 您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")])])]) : t._e(), t._v(" "), 5 == t.type ? i("ul", [i("li", [t._v("建议您按以下步骤排查问题")]), t._v(" "), i("li", [t._v("Обратитесь к своему 您的"), i("a", {
                        on: {
                            click: t.operators
                        }
                    }, [t._v("Провайдеру")]), t._v("，Принять账号密码是否正确，以及是否欠费")])]) : t._e(), t._v(" "), 3 == t.type || 4 == t.type || 5 == t.type ? i("ul", {
                        staticClass: "broad-info"
                    }, [i("li", [t._v("当前Имя пользователя信息如下")]), t._v(" "), i("li", [t._v("Имя пользователя\n          "), i("div", {
                        staticClass: "broad"
                ...
                staticRenderFns: [function() {
                    var t = this.$createElement,
                        e = this._self._c || t;
                    return e("li", [this._v("5、若仍然无法上网，Обратитесь к своему 小米客服 "), e("a", {
                        attrs: {
                    ...
                    var t = this.$createElement,
                        e = this._self._c || t;
                    return e("li", [this._v("4、若仍然无法上网，Обратитесь к своему 小米客服 "), e("a", {
                        attrs: {
                            href: "tel:400-100-5678"
                        }
                    }, [this._v("400-100-5678")])])
                    ...
                    var t = this.$createElement,
                        e = this._self._c || t;
                    return e("li", [this._v("2. 若还是不行，Обратитесь к своему 小米客服 "), e("a", {
                        attrs: {
                            href: "tel:400-100-5678"
                        }
                    }, [this._v("400-100-5678")])])
