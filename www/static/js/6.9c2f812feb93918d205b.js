    ...
    qbeB: function(e, t, s) {
        ...
        var r = s("Xxa5"),
            ...
            p = {
                            ...
                            return i.a.wrap(function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    ...
                                    case 6:
                                        ...
                                        return t.abrupt("return");
                                    case 8:
                                        return e.step = 2, e.wifi.ssid = e.wifi.name, e.wifi.nonce = e.common.Encrypt.init(), e.wifi.oldPwd = e.common.Encrypt.oldPwd("admin"), e.wifi.newPwd = e.common.Encrypt.newPwd("admin", e.routerPwd), s = {
                                            info: "auto_upgrade=" + (e.update ? 1 : 0)
                                        }, t.next = 16, e.axios.upgrade(s);
                                    case 16:
                                        return t.sent, t.next = 19, e.common.setInitLog({
                                            type: 0,
                                            step: "wire_relay_done"
                                        });
                                    case 19:
                                        return t.next = 21, e.axios.postRouterLanap(e.wifi);
                                    case 21:
                                        0 == (r = t.sent).data.code ? (e.step = 3, e.GLOBAL.adminPassword = e.routerPwd, e.GLOBAL.wifiConfigResult = r.data, e.adminPassword = e.routerPwd, e.result = r.data) : e.$router.push({
                                            path: "/error2",
                                            query: {
                                                from: "wired"
                                            }
                    ...
                    getWanLink: function() {
                        ...
                        return o()(i.a.mark(function t() {
                            ...
                            return i.a.wrap(function(t) {
                                for (;;) switch (t.prev = t.next) {
                                    case 0:
                                        return t.next = 2, e.axios.getWanLink();
                                    case 2:
                                        0 == (s = t.sent).data.code && 1 == s.data.link ? (e.step = 1, "error1" == e.frommode && e.common.setInitLog({
                                            type: 0,
                                            step: "nocable_retry_success"
                                        })) : ("error1" == e.frommode && e.common.setInitLog({
                                            type: 0,
                ...
                watch: {
                    step: function() {
                        1 == this.step && this.getWanLink()
                    }
                },
                created: function() {
                    this.wifi.name = this.common.getCookie("ssid_name") ? this.common.getCookie("ssid_name") : "", "error1" == this.$route.query.from ? (this.frommode = "error1", this.step = 1) : this.getWanLink()
                },
                mounted: function() {
                    var e = this;
            ...
            u = {
                render: function() {
                    ...
                    return s("div", [s("div", {
                        ...
                        staticClass: "loading"
                    }, [s("h3", [e._v("有线中继模式")]), e._v(" "), s("Loading", {
                        attrs: {
                            desc: "正在配置中，请等待......"
                        }
        ...
        var m = s("VU/8")(p, u, !1, function(e) {
            s("2cgU")
        }, "data-v-cea5d448", null);
        t.default = m.exports
    },
    rZov: function(e, t) {},
    teIl: function(e, t, s) {
