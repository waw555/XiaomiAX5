            ...
            i = {
                ...
                staticRenderFns: [function() {
                    ...
                    return e("div", {
                        ...
                        staticClass: "title"
                    }, [t._v("\n            重要Подсказка\n        ")]), t._v(" "), e("p", [t._v("\n            小米通讯技术有限公司（以下简称“小米”或“我们”）诚挚的邀请您加入“Redmi路由器系列产品用户体验改进计划”。为了更Принять为您提供新一代智能路由器所带来的美好智能生活，我们会根据需要对产品的各项功能的使用情况进行统计，进而通过这些统计数据更Принять完善Redmi路由器系列产品。请放心，我们像您一样厌恶个人隐私的泄露，所有统计数据仅包括您在使用Redmi路由器过程中的使用频率、方式等，这些数据以匿名的方式Сохранить，绝不涉及用户的个人隐私数据。\n        ")]), t._v(" "), e("p", {
                        staticClass: "title"
