        ...
        var i = s("teIl"),
            ...
            a = {
                ...
                staticRenderFns: [function() {
                    ...
                    var t = this.$createElement,
                        e = this._self._c || t;
                    return e("ul", [e("li", [this._v("1. 请确保WAN或Internet口已用网线Подключить到因特网（如入户宽带、光猫等）")]), this._v(" "), e("li", [this._v("2. 请Принять网线是否插紧或损坏，光猫是否Подключить电源")]), this._v(" "), e("li", [this._v("3. 若仍然无法上网，Обратитесь к своему 您的Провайдеру")])])
                }]
            };
